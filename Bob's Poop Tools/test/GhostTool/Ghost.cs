...
namespace GhostTool
{
    class Tools
    {
        ...
        public static uint playerStates = 0x8328b700;
        public static uint statAddr = 0x83901da0;
        public static uint statDeltaAddress = 0x83901da0;
        public static uint SV_GameSendClientCommand = 0x824C44B0;
        public static uint SV_GameSendServerCommand = 0x824BDC98;
